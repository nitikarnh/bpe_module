...
class bpe_employee(osv.osv):
    ...
    _columns = {
        ...
        'bpe_date_of_birth': fields.char(string='Date of Birth', size=12, help='Exam.31/04/1991'),
        'bpe_age': fields.integer(string='Age', size=2),
        'bpe_sex': fields.selection([('f', 'Male'), ('m', 'Famale')], 'Gender',help='เพศ' ),
        'bpe_marital': fields.selection([('y', 'Drafted'), ('n', 'Exempted') , ('r', 'Finish Training Crops Course')], 'Military Status',help='Drafted=ผ่านการเกณณ์,Exempted=ได้รับการยกเว้น,Finish=เรียนร.ด.' ),
