...
class bpe_employee(osv.osv):
    ...
    _columns = {
        ...
        'bpe_date_of_birth': fields.date(string='Date of Birth', size=10, help='Exam.31/04/2534'),
        ...
        'bpe_blood': fields.selection([('a', 'Group A'), ('b', 'Group B'), ('ab', 'Group AB'), ('o', 'Group O'), ],
                                      'Blood Group', ),
        'bpe_idcard': fields.char(string='Identification', size=13, help='เลขที่ประจำตัวประชาชน 13 หลัก'),
        ...
        'bpe_phone': fields.char(string='Phone', size=100, help='โทรศัพท์ที่ติดต่อได้'),
        ...
        'bpe_emergency_contact2': fields.char(string='Personal to contact emergency(2)', size=70),
        'bpe_emergency_relation2': fields.char(string='Relationship', size=30),
        'bpe_emergency_phone2': fields.char(string='Tel.', size=50),
        'bpe_marital_status': fields.selection([('single', 'โสด'), ('married', 'แต่งงานแล้ว'), ('divorce', 'หย่าร้าง')],
                                               'Marital Status', ),
        'bpe_name_spouse': fields.char(string='Spounse Name', size=100),
        'bpe_age_spouse': fields.char(string='Age', size=3),
        'bpe_job_spouse': fields.char(string='Occupation', size=256),
        'bpe_phone_spouse': fields.char(string='Tel.', size=15),
        'bpe_email_spouse': fields.char(string='Email', size=50),
        ...
        'bpe_phone_dad': fields.char(string='Tel.', size=15),
        ...
        'bpe_operation': fields.selection([('t', 'เคย'), ('f', 'ไม่เคย')], 'Operation', ),
        'bpe_operation_stell': fields.selection([('t', 'เคย'), ('f', 'ไม่เคย')], 'Operation metal', ),
