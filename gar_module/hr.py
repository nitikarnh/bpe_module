...
class hr_employee(osv.osv):
    ...
    _columns = {
        ...
        'bpe_date_of_birth': fields.date(string='ว/ด/ป เกิด', size=12, help='ตย.31/04/2534'),
        ...
        'bpe_skill_com': fields.selection([('0', 'Basic'), ('1', 'Medium'),('2','High'),('3','Spacial')], 'ทักษะคอมพิวเตอร์พื้นฐาน MS-Office (Work,Excel,Outlook)', ),
        'bpe_skill_com_special': fields.char(string='Description Spacial skill',size=50),
        'bpe_skill_lang_select': fields.selection([('0', 'Basic'), ('1', 'Medium'), ('2', 'High')],'ทักษะภาษาอังกฤษ', ),
